...
const Navbar = () => {
  return (
    <header className="header w-full flex flex-col sm:flex-row justify-between items-center p-4">
        <NavLink to="/" className="p-2 rounded-lg bg-white items-center justify-center flex font-bold shadow-md mb-4 sm:mb-0">
